...
#    in the bootstrap.servers=kafkahost:9092 can be resolved. The environment variable ZOOKEEPER_SERVERS is used to wait 
#    for the kafka topic used by the producer to be available.
...
#
#
#  We start from bde2020/kafka because all kafka command line tools and oracle java 8 are available there.
